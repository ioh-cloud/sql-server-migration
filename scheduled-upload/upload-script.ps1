...
New-Variable -Name C:\Backups -Value "" -Option Constant
New-Variable -Name medco-poc-123-dev-test-dulu -Value "" -Option Constant
New-Variable -Name C:\key-file.json -Value "" -Option Constant
New-Variable -Name medco-poc-dev -Value "" -Option Constant
